# =============================================================================
#  flowpath2.py  --  haptic force/torque controller, "flowpath2" scene variant
# =============================================================================
#
...
#
#  The ONLY differences in this variant are the (much gentler) strength
#  constants below. The device position is still routed straight into the
#  vector volume, exactly as in flowpath.py.
#
# -----------------------------------------------------------------------------
...
# --- per-scene strength constants (the only thing that differs here) --------
MAX_FORCE = 0.1
MAX_TORQUE = 3
#MAX_TORQUE=30
...
# -----------------------------------------------------------------------------
#  Build the field network (identical to flowpath.py).
# -----------------------------------------------------------------------------
