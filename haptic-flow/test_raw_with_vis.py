# =============================================================================
#  test_raw_with_vis.py  --  force/torque test for a raw vector volume, with
#                            keyboard hooks for the accompanying visualisation
# =============================================================================
#
#  Same force/torque test as test_raw.py (identical evaluator, identical
#  wiring), with two extra keyboard-matcher fields (kbS, kbSpace) added for the
#  visualisation variant of the scene. See test_raw.py for the detailed
#  explanation of the force/torque model.
#
#  The torque axis here is the device's own local Z axis, preserved exactly.
#  Module-level field names are exposed as fields of this script node and so
#  are left unchanged.
#
# -----------------------------------------------------------------------------
...
# references order: ForceTorqueField, haptics device, vector volume.
...
# Earlier wiring kept for reference.
