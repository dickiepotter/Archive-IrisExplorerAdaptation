# =============================================================================
#  flume.py  --  haptic force/torque controller, "flume" scene variant
# =============================================================================
#
#  Identical in structure and behaviour to flowpath.py; see that file for the
#  full explanation of the paddle force/torque model and the field wiring.
#
#  Two differences in this variant:
#    * the strength constants below (the strongest of the family), and
#    * the device position is NOT routed straight into the vector volume.
#      In this scene the volume's sampling position is supplied by another
#      route (the LocalInfo transform alone), so the direct
#      haptic_device.trackerPosition -> vector_volume.vector route is left
#      commented out at the foot of the file.
#
# -----------------------------------------------------------------------------
...
# references order: ForceTorqueField, haptics device, vector volume, LocalInfo.
...
# -----------------------------------------------------------------------------
#  Build the field network. Note the commented-out trackerPosition route: in
#  the flume scene the sampling position comes from the LocalInfo transform.
# -----------------------------------------------------------------------------
