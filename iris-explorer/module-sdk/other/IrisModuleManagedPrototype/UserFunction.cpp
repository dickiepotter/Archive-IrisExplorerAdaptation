...
extern "C"
{
	...
	cxErrorCode cxPortCheckIn ( int linkC, void *links[], long *cxMDWPortID, long *linkIDs ) {return cx_err_none;}
	cxErrorCode cxPortCheckOut ( int linkC, void *links[], long *cxMDWPortID ){return cx_err_none;}
}