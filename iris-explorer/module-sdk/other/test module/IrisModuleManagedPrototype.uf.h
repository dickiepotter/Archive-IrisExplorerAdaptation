...
#ifndef _IrisModuleManagedPrototype_UF_H_
#define _IrisModuleManagedPrototype_UF_H_

/* 
 * User function prototypes subprogram for module IrisModuleManagedPrototype.
